    ...
    overlay.innerHTML = `
      <div class="modal-dialog modal-large">
        ...
        <div class="modal-body">
          ...
          <div class="look-section-card" style="z-index: 30;">
            <div class="look-section-header">
              <span class="look-section-icon" style="background: rgba(207, 65, 16, 0.1); color: #cf4110;">
              ...
              <strong class="look-section-title">1. Orchis Theme (GTK &amp; Shell)</strong>
            </div>

            <div class="look-grid-3col">
              <div class="form-group">
          ...
          <div class="look-section-card" style="z-index: 20;">
            <div class="look-section-header">
              <span class="look-section-icon" style="background: rgba(59, 130, 246, 0.1); color: #2563eb;">
                <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <strong class="look-section-title">2. Tela Icon Theme</strong>
            </div>
          ...
          <div class="look-section-card" style="z-index: 10;">
            <div class="look-section-header">
              <span class="look-section-icon" style="background: rgba(16, 185, 129, 0.1); color: #059669;">
                <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="m3 3 7.07 16.97 2.51-7.39 7.39-2.51L3 3z"></path>
                  <path d="m13 13 6 6"></path>
                </svg>
              </span>
              <strong class="look-section-title">3. Bibata Cursor</strong>
            </div>

            <div class="look-grid-2col">
              <div class="form-group">
